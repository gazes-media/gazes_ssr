import { AppShell, Burger, Flex, Text, Input, Image, rem, Kbd, NavLink as NavButton, Avatar } from "@mantine/core";
  ...
  return <AppShell
    ...
    >
      ...
      <AppShell.Navbar p="md">
        ...
        <NavLink label="Historique" leftSection={<IconHistory />} navigate={navigate} location="/history" />
